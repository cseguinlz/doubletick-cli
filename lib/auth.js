...
// Shipped OAuth credentials — users don't need to provide their own
const DEFAULT_CLIENT_ID = '512899922848-e0grspa1dfh0jnbjtj1fhavvl4uv34up.apps.googleusercontent.com';
const DEFAULT_CLIENT_SECRET = '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';
...
export async function authenticate(clientId = DEFAULT_CLIENT_ID, clientSecret = DEFAULT_CLIENT_SECRET) {
  ensureConfigDir();
